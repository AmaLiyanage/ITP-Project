...
const AdminSignUp = () => {
  ...
  const handleSignUp = async (e) => {
    ...
    try {
      await signup(email, password, name, true); // Pass true for isAdmin
      navigate("/adminlogin");
    } catch (error) {
      console.log(error);
    }
          ...
          <form onSubmit={handleSignUp}>
            ...
            <motion.button
              className="mt-5 w-full py-3 px-4 bg-gradient-to-r from-blue-500 to-indigo-600 text-white 
                ...
                focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-900 transition duration-200"
