        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
          ...
          <div className="px-6 py-5 border-b border-gray-200 bg-gray-50">
            <div className="flex flex-wrap items-center justify-between">
              ...
              <div className="flex space-x-4 mt-4 sm:mt-0">                <button
                  onClick={handleDownloadReport}
                  className="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-all duration-200 flex items-center space-x-2 shadow-sm hover:shadow transform hover:-translate-y-0.5"
                >
