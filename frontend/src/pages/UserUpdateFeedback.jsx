          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between pt-6">
              ...
              <button
                type="submit"
                disabled={submitting}
                className={`px-6 py-3 bg-blue-600 text-white rounded-lg transition-all duration-200 ${submitting ? "opacity-70 cursor-not-allowed" : "hover:bg-blue-700 transform hover:scale-105"} flex items-center space-x-2`}
              >
                {submitting ? (
                  <>
